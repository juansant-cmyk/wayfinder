...
class Settings(BaseSettings):
    ...
    cors_origins: str = (
        "http://localhost:8081,http://localhost:8082,http://localhost:8085,http://localhost:8086,"
        "http://localhost:8087,http://localhost:19006,"
        "http://127.0.0.1:8081,http://127.0.0.1:8082,http://127.0.0.1:8085,http://127.0.0.1:8086,"
