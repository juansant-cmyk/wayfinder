...
const cases = [
  ["hotels", null, "Home from hotels must not think Home is already active"],
  ["home", "Home", "home highlights Home"],
  ["itinerary", "Itinerary", "itinerary highlights Itinerary"],
  ["trips", "Trips", "trips highlights Trips"],
  ["favorites", "Saved", "favorites highlights Saved"],
...
if (getBottomNavRoute("Trips") === "itinerary") {
  console.error("FAIL Trips must not route to itinerary");
  failed += 1;
}
